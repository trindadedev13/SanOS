...
Signature:   db 0x29
VolumeID:    dd 0x00
VolumeLabel: db "SANOS      "
FileSystem:  db "FAT12   "

; OS Start
BootMain:
        mov     [DriveNumber], dl  ; Save Drive's number
...
kernelbin:     db 'KERNEL  BIN'  ; The kernel binary name in Fat12
kernelcluster: dw 0x00           ; The kernel cluster number in Fat12

; Fill the bytes with 0x00 to fit 512
times 510 - ($ - $$) db 0x00
dw 0xAA55
